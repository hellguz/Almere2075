...
THREAT_KNOWLEDGE_BASE = {
    ...
    "extreme-storm": "The sky is a dark, churning vortex of black and grey supercell clouds, illuminated by constant, strobing flashes of lightning. Hurricane-force winds tear entire panels and sections of cladding from building facades, revealing skeletal structures beneath. A torrential downpour of horizontal rain and hail creates a whiteout effect, blurring everything. The air is a chaotic tempest of airborne debris, from small projectiles to heavy objects like dumpsters, streetlights, and entire uprooted trees being violently propelled through the air. Streets have become raging torrents, with the wind and floodwaters powerful enough to roll cars and trucks over. Power lines are snapped, whipping wildly and throwing showers of sparks."
}
